...
inline void fillVec4(vec4 a, double x, double y, double z, double l)
{
    a[0] = x;
    a[1] = y;
    a[2] = z;
...
inline void lookAtInit()
{
    direction = cvec4(0, 0, 0, 0);
    cameraRight = cvec4(0, 0, 0, 0);
    cameraUp = cvec4(0, 0, 0, 0);
